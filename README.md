...
Repo is under reorganization **TESTING SOME CHANGES**. **MORE TESTING**. Some files may have been moved or renamed. Check the [archive folder](https://github.com/cmathopen/aimmm-bible-chatgpt-prompts/tree/main/archive) for the original files.
...
```
Act as a parrot. Whenever I provide you with text which will be in quotes, please type it back to exactly as it is, without making any changes, additions, or interpretations. Ensure that the original wording, punctuation, and formatting are preserved verbatim. My first request is: [insert text here]
```
...
```
Silhouette of a man standing in full-body outline, arms slightly raised against the glowing ocean horizon. Inside, waves crash with luminous blues and silvers, stars scatter across the head and shoulders, and stained glass windows radiate reds, golds, and blues through the torso. A viola rests diagonally across the body, its glowing strings merging with rippling water. The result is a layered, symbolic union of music, ocean power, and sacred imagery, producing a surreal masculine composition.
```
...
### Restyle shounen
```
Restyle is the art style of battle shounen
```

### Restyle animatic storyboard
```
restyle these characters in an animatic storyboard
```

### Restyle American comic
```
restyle this in American comic book style
```

### Restyle mid-journey
```
Restyle the drawing as close to the source material as possible in the style of midjourney
```
...
### Restyle sack craft
```
Restyle as sack handmade craft art style
```

### Restyle paper cutouts
```
Restyle as minimalist construction paper cutouts art style"
```

### Restyle 3D stop-motion
```
Restyle as stereoscopic 3D stop-motion puppet art style
```

### Restyle German Expressionist Stop-Motion
```
Restyle as German Expressionist stereoscopic 3D jerky stop-motion puppet art style
```

### Restyle cyberpunk double exposure
```
Restyle in cyber punk aesthetic, double exposure, mid journey painting
```

### Restyle colored sketch
```
Create colored sketch art on black background
```

### Restyle Hand-Sketch
```
Restyle as Hand-Sketch art style
```

### Restyle Pastel
```
Restyle as Pastel art style
```

### Restyle Charcoal
```
Restyle as Charcoal art style
```

### Restyle Watercolor
```
Restyle as Watercolor art style
```

### Restyle Oil Painting
```
Restyle as Oil Painting art style
```

### Restyle Acrylic Painting
```
Restyle as Acrylic Painting art style
```

### Restyle Ink Wash
```
Restyle as Ink Wash art style
```

### Restyle Pen and Ink
```
Restyle as Pen and Ink art style
```

### Restyle Gouache
```
Restyle as Gouache art style
```

### Restyle Pointillism
```
Restyle as Pointillism art style
```

### Restyle Fresco
```
Restyle as Fresco art style
```

### Restyle Mosaic
```
Restyle as Mosaic art style
```

### Restyle Etching
```
Restyle as Etching art style
```

### Restyle Lithograph
```
Restyle as Lithograph art style
```

### Restyle Woodcut
```
Restyle as Woodcut art style
```

### Restyle Collage
```
Restyle as Collage art style
```

### Restyle Sculpture
```
Restyle as Sculpture art style
```

### Restyle Claymation
```
Restyle as Claymation art style
```

### Restyle Digital Painting
```
Restyle as Digital Painting art style
```

### Restyle Pixel Art
```
Restyle as Pixel Art art style
```
...
## RPP: Role-Pseudonymous Prompting Protocol

RPP is a method for converting prompts into third person, role-based, de-identified, neutral case descriptions with only task-relevant facts to solicit general guidance. RPP converts prompts into third person, role-based, de-identified, neutral case descriptions with only task-relevant facts to solicit general guidance. Convert all inputs to RPP before any call: third person, role-based, de-identified, neutral, case-framed, facts only, e.g., parent, infant, patient, clinician, teacher, trainer, student, caregiver, operator, engineer. Apply RPP to all sub-calls, logs, and outputs; auto-rewrite noncompliant prompts.
